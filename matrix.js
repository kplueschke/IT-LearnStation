...
function updateScoreDisplay() {
    ...
    if (!scoreDisplay) {
        ...
        scoreDisplay.className = 'fixed top-16 left-4 md:top-4 md:left-[350px] inline-flex items-center justify-center px-4 h-10 rounded-full bg-slate-800/50 border border-slate-700/50 text-slate-400 font-mono text-sm z-50 pointer-events-none transition-opacity duration-300';
